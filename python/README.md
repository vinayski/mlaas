...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**predict_post**](docs/DefaultApi.md#predict_post) | **POST** /predict | Predicts from test data
*DefaultApi* | [**train_post**](docs/DefaultApi.md#train_post) | **POST** /train | trains the model
